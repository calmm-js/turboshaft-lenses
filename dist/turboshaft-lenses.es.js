import { sndU, curry, always, defineNameU, inherit, applyU, id } from 'infestines';
...
var mkC = function mkC($, Con) {
  return inherit(copyName(Con, $), Object, { $: $ });
};
...
var Always = /*#__PURE__*/fn1(function always$$1(_x, _i) {
  return this.$1;
});
...
var Id = /*#__PURE__*/constant(function id$$1(x, _i) {
  return x;
});
...
var ReaderGeneric = /*#__PURE__*/fn3(function reader(x, i) {
  return this.$3(always(x), this.$2.$(this.$1(x, i), i));
});
...
var foldl = /*#__PURE__*/curry(function foldl(axi2a, a, o, s) {
  var r = Foldl(axi2a, a);
...
export { toOptic, elems, when, forEach, foldl, get, getAs, modify, set, sum };
